...
xsd.exe S421_2.0.xsd ../Common/S100_gmlProfile.xsd ../Common/s100gmlbase.xsd ../Common/xlink.xsd ../Common/xml.xsd /classes /language:CS /namespace:S100Schema.Schemas.S421 /out:.

::Rename output file to e.g. S421.cs
